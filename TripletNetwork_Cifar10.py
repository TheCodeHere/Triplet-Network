...
File_name = "Log/TripletNet/Cifar10/" + str(output_dim) + "d/Cifar10_" + str(recall) + "_bs-" + str(batch_size) + "_eps-" + str(epochs) + "_lr-" + str(max_lr) + "_m-" + str(margin) + ".pth"
