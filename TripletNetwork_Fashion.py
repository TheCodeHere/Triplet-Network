...
File_name = "Log/TripletNet/Fashion/" + str(output_dim) + "d/Fashion_rec-" + str(recall) + "_bs-" + str(batch_size) + "_eps-" + str(epochs) + "_lr-" + str(max_lr) + "_m-" + str(margin) + ".pth"
