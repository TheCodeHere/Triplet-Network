...
# Model (on Device)
tripletNetwork_model = to_device(ResNet_size(size=10, in_channels=1, output_size=output_dim, margin=margin), device)
...
File_name = "Log/TripletNet/MNIST/" + str(output_dim) + "d/MNIST_" + str(mean_loss) + ".pth"
